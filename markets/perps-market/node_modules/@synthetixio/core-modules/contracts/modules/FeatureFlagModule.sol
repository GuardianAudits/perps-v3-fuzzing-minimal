...
contract FeatureFlagModule is IFeatureFlagModule {
    ...
    function setFeatureFlagAllowAll(bytes32 feature, bool allowAll) external override {
        console2.log("===== FeatureFlagModule::setFeatureFlagAllowAll START =====");
        console2.log("Before only owner");
        OwnableStorage.onlyOwner();
        console2.log("After only owner");
        ...
        console2.log("===== FeatureFlagModule::setFeatureFlagAllowAll END =====");
    }
