...
export interface IDecayTokenModuleInterface extends utils.Interface {
  functions: {
...
export interface IDecayTokenModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IDecayTokenModuleInterface;
