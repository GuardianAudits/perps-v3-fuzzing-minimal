...
export interface DecayTokenModuleInterface extends utils.Interface {
  functions: {
...
export interface DecayTokenModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DecayTokenModuleInterface;
