...
exports.resolveCliSettings = exports.PROVIDER_URL_DEFAULT = void 0;
...
exports.PROVIDER_URL_DEFAULT = 'frame,direct';
/**
 * Settings zod schema.
...
function cannonSettingsSchema(fileSettings) {
    return {
        ...
        CANNON_PROVIDER_URL: zod_1.z.string().default(fileSettings.providerUrl || exports.PROVIDER_URL_DEFAULT),
