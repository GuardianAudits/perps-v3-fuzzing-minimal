...
exports.ReadOnlyOnChainRegistry = exports.LocalRegistry = void 0;
...
async function createDefaultReadRegistry(cliSettings, additionalRegistries = []) {
    ...
    if (cliSettings.registryPriority === 'offline') {
        ...
        console.log((0, chalk_1.yellowBright)('⚠️  You are not connected to the internet or using a VPN that is limiting connectivity. Cannon will only use packages available locally.'));
        return new builder_1.FallbackRegistry([...additionalRegistries, localRegistry]);
    }
