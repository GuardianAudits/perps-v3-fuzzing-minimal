...
exports.getChainIdFromProviderUrl = exports.isURL = exports.ProviderOrigin = void 0;
...
async function resolveWriteProvider(settings, chainId) {
    ...
    console.log((0, chalk_1.bold)(`Resolving connection to ${(0, chains_1.getChainById)(chainId)} (Chain ID: ${chainId})...`));
    ...
    if (settings.providerUrl == settings_1.PROVIDER_URL_DEFAULT && !settings.quiet) {
        console.warn((0, chalk_1.grey)('Set a RPC URL by passing --provider-url or setting the ENV variable CANNON_PROVIDER_URL.\n'));
    }
...
async function resolveProviderAndSigners({ chainId, checkProviders = ['frame'], privateKey, origin, }) {
    ...
    if (origin === ProviderOrigin.Write) {
        console.log((0, chalk_1.grey)(`Attempting to find connection via ${(0, chalk_1.bold)(providerDisplayName(checkProviders[0]))}`));
