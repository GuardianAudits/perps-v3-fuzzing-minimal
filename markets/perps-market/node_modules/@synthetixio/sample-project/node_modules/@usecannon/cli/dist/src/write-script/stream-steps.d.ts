 ...
 */
export declare function createStepsStream(runtime: ChainBuilderRuntime): {
    stream: StepEventsStream;
    fetchTransactions: Transform;
};
declare class StepEventsStream extends Readable {
    private runtime;
...
export {};
//# sourceMappingURL=stream-steps.d.ts.map