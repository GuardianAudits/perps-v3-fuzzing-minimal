...
export interface SpotMarketRouterInterface extends utils.Interface {
  functions: {
...
export interface SpotMarketRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SpotMarketRouterInterface;
