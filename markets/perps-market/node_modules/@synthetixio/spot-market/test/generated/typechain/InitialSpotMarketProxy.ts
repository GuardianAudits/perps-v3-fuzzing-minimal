...
export interface InitialSpotMarketProxyInterface extends utils.Interface {
  functions: {
...
export interface InitialSpotMarketProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InitialSpotMarketProxyInterface;
