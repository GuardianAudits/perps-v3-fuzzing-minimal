...
export interface AsyncOrderConfigurationModuleInterface
...
export interface AsyncOrderConfigurationModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AsyncOrderConfigurationModuleInterface;
