...
export interface IAsyncOrderSettlementModuleInterface extends utils.Interface {
  functions: {
...
export interface IAsyncOrderSettlementModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAsyncOrderSettlementModuleInterface;
  ...
  callStatic: {
    settleOrder(
      ...
      [BigNumber, OrderFees.DataStructOutput] & { finalOrderAmount: BigNumber }
    >;
  };
