...
export interface ISynthTokenModuleInterface extends utils.Interface {
  functions: {
...
export interface ISynthTokenModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISynthTokenModuleInterface;
