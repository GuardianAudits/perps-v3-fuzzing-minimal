...
export interface IAtomicOrderModuleInterface extends utils.Interface {
  functions: {
...
export interface IAtomicOrderModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAtomicOrderModuleInterface;
