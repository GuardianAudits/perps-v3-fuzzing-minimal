...
export interface SpotMarketFactoryModuleInterface extends utils.Interface {
  functions: {
...
export interface SpotMarketFactoryModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SpotMarketFactoryModuleInterface;
