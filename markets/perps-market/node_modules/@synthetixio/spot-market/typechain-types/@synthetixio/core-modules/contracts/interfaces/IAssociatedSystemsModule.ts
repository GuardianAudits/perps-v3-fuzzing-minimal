...
export interface IAssociatedSystemsModuleInterface extends utils.Interface {
  functions: {
...
export interface IAssociatedSystemsModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAssociatedSystemsModuleInterface;
