...
export interface MockRewardsDistributorExternalInterface
...
export interface MockRewardsDistributorExternal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockRewardsDistributorExternalInterface;
