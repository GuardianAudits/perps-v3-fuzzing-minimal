...
export interface IGlobalPerpsMarketModuleInterface extends utils.Interface {
  functions: {
...
export interface IGlobalPerpsMarketModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGlobalPerpsMarketModuleInterface;
