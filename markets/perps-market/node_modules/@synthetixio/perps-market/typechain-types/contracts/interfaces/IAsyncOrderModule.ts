...
export interface IAsyncOrderModuleInterface extends utils.Interface {
  functions: {
...
export interface IAsyncOrderModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAsyncOrderModuleInterface;
