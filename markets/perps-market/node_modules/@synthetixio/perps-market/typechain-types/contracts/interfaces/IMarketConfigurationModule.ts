...
export interface IMarketConfigurationModuleInterface extends utils.Interface {
  functions: {
...
export interface IMarketConfigurationModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMarketConfigurationModuleInterface;
  ...
  functions: {
    ...
    getLockedOiRatio(
      marketId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { lockedOiRatioD18: BigNumber }>;
