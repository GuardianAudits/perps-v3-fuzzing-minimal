...
export interface IPerpsMarketFactoryModuleInterface extends utils.Interface {
  functions: {
...
export interface IPerpsMarketFactoryModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPerpsMarketFactoryModuleInterface;
