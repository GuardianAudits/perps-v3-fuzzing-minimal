...
export interface PerpsMarketModuleInterface extends utils.Interface {
  functions: {
...
export interface PerpsMarketModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsMarketModuleInterface;
