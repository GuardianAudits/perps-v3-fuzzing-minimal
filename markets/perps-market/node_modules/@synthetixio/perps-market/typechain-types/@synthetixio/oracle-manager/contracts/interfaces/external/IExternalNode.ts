...
export interface IExternalNodeInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "isValid" | "process" | "supportsInterface"
  ): FunctionFragment;
...
export interface IExternalNode extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IExternalNodeInterface;
  ...
  functions: {
    isValid(
      nodeDefinition: NodeDefinition.DataStruct,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    process(
      parentNodeOutputs: NodeOutput.DataStruct[],
      parameters: BytesLike,
