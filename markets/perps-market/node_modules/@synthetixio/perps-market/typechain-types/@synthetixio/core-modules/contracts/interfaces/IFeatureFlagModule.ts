...
export interface IFeatureFlagModuleInterface extends utils.Interface {
  functions: {
...
export interface IFeatureFlagModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFeatureFlagModuleInterface;
