...
import type {
  IAtomicOrderModule,
  IAtomicOrderModuleInterface,
} from "../../../../../@synthetixio/spot-market/contracts/interfaces/IAtomicOrderModule";
...
export class IAtomicOrderModule__factory {
  static readonly abi = _abi;
  static createInterface(): IAtomicOrderModuleInterface {
    return new utils.Interface(_abi) as IAtomicOrderModuleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAtomicOrderModule {
    return new Contract(address, _abi, signerOrProvider) as IAtomicOrderModule;
  }
}
