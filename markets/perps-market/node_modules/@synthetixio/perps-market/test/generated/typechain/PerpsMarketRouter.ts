...
export interface PerpsMarketRouterInterface extends utils.Interface {
  functions: {
...
export interface PerpsMarketRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsMarketRouterInterface;
