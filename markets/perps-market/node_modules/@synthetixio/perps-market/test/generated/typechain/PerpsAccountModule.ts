...
export interface PerpsAccountModuleInterface extends utils.Interface {
  functions: {
...
export interface PerpsAccountModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsAccountModuleInterface;
