...
export interface AsyncOrderSettlementPythModuleInterface
...
export interface AsyncOrderSettlementPythModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AsyncOrderSettlementPythModuleInterface;
