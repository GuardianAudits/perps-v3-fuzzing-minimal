...
import type {
  PerpsMarketProxy,
  PerpsMarketProxyInterface,
} from "../PerpsMarketProxy";
...
export class PerpsMarketProxy__factory {
  static readonly abi = _abi;
  static createInterface(): PerpsMarketProxyInterface {
    return new utils.Interface(_abi) as PerpsMarketProxyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PerpsMarketProxy {
    return new Contract(address, _abi, signerOrProvider) as PerpsMarketProxy;
  }
}
