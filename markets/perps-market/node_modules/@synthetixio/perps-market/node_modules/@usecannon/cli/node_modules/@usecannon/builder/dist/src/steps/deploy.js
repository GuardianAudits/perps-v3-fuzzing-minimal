...
function generateOutputs(config, ctx, artifactData, deployTxn, deployTxnBlock, deployAddress, currentLabel) {
...
const deploySpec = {
    ...
    async exec(runtime, ctx, config, packageState) {
        ...
        try {
            ...
            const contractArtifact = generateOutputs(config, ctx, artifactData, receipt, null, 
