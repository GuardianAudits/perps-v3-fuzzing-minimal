...
const debugVerbosity = [
    ...
    {
        flags: '-vv',
        description: 'Print logs for builder and its definition section, equivalent to DEBUG=cannon:builder, cannon:builder:definition',
    },
    {
        flags: '-vvv',
...
const anvilOptions = [
    ...
    {
        flags: '--state [path]',
        description: "Alias for both loadState and dumpState. Initializes the chain with the state stored at the file, if it exists, and dumps the chain's state on exit.",
    },
    {
...
const commandsConfig = {
    run: {
        ...
        options: [
            ...
            },
            {
                ...
                defaultValue: constants_1.ANVIL_FIRST_ADDRESS,
            },
            {
                flags: '--mnemonic <phrase>',
    ...
    build: {
        ...
        options: [
            ...
            },
            {
                ...
                description: '(DEPRECATED) The preset label for storing the build with the given settings. Declare a preset in your cannonfile instead.',
            },
            {
                flags: '--dry-run',
            ...
            {
                flags: '--keep-alive',
                description: 'After completing build, leave RPC open and switch into run mode. Has no effect on live network deployment.',
            },
            {
                flags: '--private-key [key]',
                description: 'Specify a comma separated list of private keys which may be needed to sign a transaction',
    ...
    alter: {
        ...
        arguments: [
            ...
            {
                flags: '<command>',
                description: 'Alteration command to execute. Current options: set-url, set-contract-address, mark-complete, mark-incomplete',
            },
            {
                flags: '[options...]',
        ...
        options: [
            ...
            },
            {
                ...
                description: 'When the change needs to be made in a subpackage, specify the step names leading to the subpackage, comma separated.',
            },
            {
                flags: '-n --provider-url [url]',
    ...
    publish: {
        description: 'Publish a Cannon package to the registry (Note that the registry collects some ETH, indicated in the CLI output, to support an IPFS cluster that automatically pins package data.)',
        arguments: [
            {
                flags: '<packageRef>',
...
exports.default = commandsConfig;
//# sourceMappingURL=commandsConfig.js.map