...
async function call(client, args) {
    const { account: account_ = client.account, batch = Boolean(client.batch?.multicall), blockNumber, blockTag = 'latest', accessList, blobs, data: data_, factory, factoryData, gas, gasPrice, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, nonce, to, value, stateOverride, ...rest } = args;
...
function toCounterfactualData(parameters) {
    ...
    return (0, encodeDeployData_js_1.encodeDeployData)({
        ...
        bytecode: contracts_js_1.counterfactualContractCallByteCode,
