...
export interface ImplementationMockBInterface extends utils.Interface {
  functions: {
    "getA()": FunctionFragment;
    "getB()": FunctionFragment;
    "getImplementation()": FunctionFragment;
    "setA(uint256)": FunctionFragment;
    "setB(string)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "getB", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "getImplementation",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "setA", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "setB", values: [string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "getB", data: BytesLike): Result;
...
export interface ImplementationMockB extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ImplementationMockBInterface;
  ...
  functions: {
    ...
    getB(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    setA(newA: BigNumberish, overrides?: CallOverrides): Promise<void>;

    setB(newB: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    getB(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getB(overrides?: CallOverrides): Promise<PopulatedTransaction>;
