...
export interface UUPSImplementationMockInterface extends utils.Interface {
  functions: {
...
export interface UUPSImplementationMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UUPSImplementationMockInterface;
