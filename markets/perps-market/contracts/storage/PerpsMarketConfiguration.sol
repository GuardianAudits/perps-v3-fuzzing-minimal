...
library PerpsMarketConfiguration {
    ...
    {
        // console2("size", int256(size));
        // console2("price", price);

        if (size == 0) {
            // console2("size is 0, returning all zeros");
            return (0, 0, 0, 0);
        }

        uint256 sizeAbs = MathUtil.abs(size.to256());
        // console2("sizeAbs", sizeAbs);

        // console2("self.skewScale", self.skewScale);
        uint256 impactOnSkew = self.skewScale == 0
            ? 0
            : sizeAbs.divDecimal(self.skewScale);
        // console2("impactOnSkew", impactOnSkew);

        // console2("self.initialMarginRatioD18", self.initialMarginRatioD18);
        // console2.log(
        //     "self.minimumInitialMarginRatioD18",
        //     self.minimumInitialMarginRatioD18
        // );
        initialMarginRatio =
            impactOnSkew.mulDecimal(self.initialMarginRatioD18) +
            self.minimumInitialMarginRatioD18;
        // console2("initialMarginRatio", initialMarginRatio);
        ...
        // console2("maintenanceMarginRatio", maintenanceMarginRatio);

        uint256 notional = sizeAbs.mulDecimal(price);
        // console2("notional", notional);

        // console2("self.minimumPositionMargin", self.minimumPositionMargin);
        initialMargin =
            notional.mulDecimal(initialMarginRatio) +
            self.minimumPositionMargin;
        // console2.log("<isLiquidationFlow> required initialMargin", initialMargin);

        maintenanceMargin =
            notional.mulDecimal(maintenanceMarginRatio) +
            self.minimumPositionMargin;
        // console2("maintenanceMargin", maintenanceMargin);

        // console2("Final initialMarginRatio", initialMarginRatio);
        // console2("Final maintenanceMarginRatio", maintenanceMarginRatio);
        // console2("Final initialMargin", initialMargin);
        // console2("Final maintenanceMargin", maintenanceMargin);
    }
    /**
