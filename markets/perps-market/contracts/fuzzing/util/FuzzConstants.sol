...
abstract contract FuzzConstants {
    ...
    bytes32 internal constant HUGE_ORACLE_NODE_ID = "3";

    bytes32 internal constant KEEPER_NODE_ID = "5";

    bytes32 internal constant WETH_PYTH_PRICE_FEED_ID = "2";
    bytes32 internal constant WBTC_PYTH_PRICE_FEED_ID = "3";
    bytes32 internal constant HUGE_PYTH_PRICE_FEED_ID = "3";
    ...
    int64 internal constant WBTC_STARTING_PRICE = 10_000 * 1e8;
    uint64 internal constant WBTC_STARTING_CONF = 1;
    int32 internal constant WBTC_STARTING_EXPO = -8;

    int64 internal constant HUGE_STARTING_PRICE = 1_111 * 1e8;
    uint64 internal constant HUGE_STARTING_CONF = 1;
    int32 internal constant HUGE_STARTING_EXPO = -8;

    uint128 internal constant REWARD_DISTRIBUTOR_WETH_POOL_ID = 1;
    uint128 internal constant REWARD_DISTRIBUTOR_WBTC_POOL_ID = 2;
    uint128 internal constant REWARD_DISTRIBUTOR_HUGE_POOL_ID = 3;
    ...
    uint128 internal constant HUGE_MARKET_SKEW_SCALE = 10000e18;
    ...
    // Settlement strategy HUGE
    SettlementStrategy.Type internal constant HUGE_SETTLEMENT_STRATEGY_TYPE =
        SettlementStrategy.Type.PYTH;
    uint256 internal constant HUGE_SETTLEMENT_DELAY = 5;
    uint256 internal constant HUGE_SETTLEMENT_WINDOW_DURATION = 120;
    bytes32 internal constant HUGE_FEED_ID = "3";
    uint256 internal constant HUGE_SETTLEMENT_REWARD = 5e18;
    bool internal constant HUGE_DISABLED = false;
    uint256 internal constant HUGE_COMMITMENT_PRICE_DELAY = 2;
    ...
    // HUGE Collateral Configuration
    uint256 internal constant HUGE_COLLATERAL_ID = 3;
    uint256 internal constant HUGE_MAX_COLLATERAL_AMOUNT = type(uint256).max;
    uint256 internal constant HUGE_UPPER_LIMIT_DISCOUNT = 0;
    uint256 internal constant HUGE_LOWER_LIMIT_DISCOUNT = 0;
    uint256 internal constant HUGE_DISCOUNT_SCALAR = 0;
    ...
    uint128 internal constant HUGE_COLLATERALS_PER_ACCOUNT = 100000;
    ...
    // HUGE Funding Parameters
    uint128 internal constant HUGE_SKEW_SCALE = 1_000_000e18;
    uint256 internal constant HUGE_MAX_FUNDING_VELOCITY = 0;
    ...
    uint128 internal constant HUGE_MAX_MARKET_SIZE = 27_000 * 1e18; //10_000_000;

    // Max Market Values
    uint256 internal constant WETH_MAX_MARKET_VALUE = 0;
    uint256 internal constant WBTC_MAX_MARKET_VALUE = 0;
    uint256 internal constant HUGE_MAX_MARKET_VALUE = 0;
    ...
    uint256 internal constant HUGE_MAKER_FEE_RATIO = 0.003e18;
    uint256 internal constant HUGE_TAKER_FEE_RATIO = 0.006e18;
    ...
    // WBTC Liquidation Parameters
    uint256 internal constant HUGE_INITIAL_MARGIN_FRACTION = 2e18;
    uint256 internal constant HUGE_MINIMUM_INITIAL_MARGIN_RATIO = 0.01e18;
    uint256 internal constant HUGE_MAINTENANCE_MARGIN_SCALAR = 0.5e18;
    uint256 internal constant HUGE_LIQUIDATION_REWARD_RATIO = 0.05e18;
    uint256 internal constant HUGE_MINIMUM_POSITION_MARGIN = 1000e18;

    // WETH Max Liquidation Parameters
    uint256
        internal constant WETH_MAX_LIQUIDATION_LIMIT_ACCUMULATION_MULTIPLIER =
        0.00001e18;
    ...
    uint256
        internal constant WBTC_MAX_LIQUIDATION_LIMIT_ACCUMULATION_MULTIPLIER =
        0.00001e18;
    ...
    // HUGE Max Liquidation Parameters
    uint256
        internal constant HUGE_MAX_LIQUIDATION_LIMIT_ACCUMULATION_MULTIPLIER =
        0.00001e18;
    uint256 internal constant HUGE_MAX_SECONDS_IN_LIQUIDATION_WINDOW = 60;
    uint256 internal constant HUGE_MAX_LIQUIDATION_PD = 0;
    address internal constant HUGE_ENDORSED_LIQUIDATOR = address(0);
