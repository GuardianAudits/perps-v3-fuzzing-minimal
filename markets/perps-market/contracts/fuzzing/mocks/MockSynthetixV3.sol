...
contract MockSynthetixV3 {
    ...
    */
    ...
    function getWithdrawableMarketUsd(
        ...
        // console2("withdrawableUsd", withdrawableUsd);
    ...
    */
    ...
    function withdrawMarketUsd(
        ...
        // console2("marketId", marketId);
        // console2("target", target);
        // console2("amount", amount);

        MockERC20(sUSD).mint(target, amount);
        // console2("Minted to target", amount);

        uint256 feeAmount = (amount * FEE_PERCENT) / 1e18;
        // console2("feeAmount", feeAmount);

        MockERC20(sUSD).mint(address(1), feeAmount);
        // console2("Minted fee to address(1)", feeAmount);
        ...
        // console2("creditCapacity before", creditCapacity);
        creditCapacity -= (amount + feeAmount);
        // console2("creditCapacity after", creditCapacity);

        // console2("Returning feeAmount", feeAmount);
        return feeAmount;
    }
