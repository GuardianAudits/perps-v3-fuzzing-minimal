...
contract MockRouter {
    event AddedFunctionAndImplementation(bytes4 selector, address implementation);
    ...
    function addFunctionAndImplementation(bytes4 selector, address implementation) external {
